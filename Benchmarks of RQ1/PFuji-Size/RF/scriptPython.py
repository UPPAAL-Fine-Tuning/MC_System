...
def modify_and_run_rf(NE_value, it_value, Pm0_value, rf_file):
    ...
    for i, line in enumerate(lines):
        if 'model = RandomForestClassifier' in line:
            lines[i] = f'model = RandomForestClassifier(n_estimators={NE_value}, random_state=None)\n'
    ...
    if accuracy_match:
        Pm_value = int(accuracy_match.group(1))
    else:
...
def main():
    trace_file = r'C:\Users\SYRINE\Desktop\RandomForest\traceRF.uctr'
    rf_file = r'C:\Users\SYRINE\Desktop\RandomForest\RandomForestCode.py'
    xml_file = r'C:\Users\SYRINE\Desktop\RandomForest\modeleRF.xml'
    ...
    if NE_value is not None and it_value is not None and Pm0_value is not None:
        print("Extracted NE_value from traceRF.uctr:", NE_value)
        ...
        print("Error: Unable to find NE_value, it, or Pm0 in traceRF.uctr.")
